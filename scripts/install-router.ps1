...
# --- 3b. clear any leftover auth variables ---------------------------------
# Earlier versions of this project required a shared token on /print. It has
# been removed; drop the variables so a stale value cannot confuse anyone
# reading the machine later.
foreach ($v in "PHOTOBOOTH_TOKEN", "PHOTOBOOTH_AUTH") {
...
Write-Host "      https://${ServerIP}:5443/booth"
